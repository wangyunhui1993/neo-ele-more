<template>
	<view class="content">
		<view class="logo">
			<image src="/static/common/img/mt-ban.png" mode="widthFix"></image>
		</view>
		<view class="step">
		...
		<view class="coupon">
			<view class="coupon-item" @click="openCoupon('mtwm')">
				<view class="logo">
					<image src="/static/common/img/美团外卖.png" mode="widthFix"></image>
				</view>
				<view class="title">美团外卖红包</view>
				<view class="getBtn">
					立即领取
				</view>
			</view>
			<view class="coupon-item" @click="openCoupon('mtsc')">
				<view class="logo">
					<image src="/static/common/img/美团外卖.png" mode="widthFix"></image>
				</view>
		...
		<view class="bottom-btn">
			<view span="6" class="item active" @click="openAnother">
				<image src="/static/common/img/饿了么.png" mode="widthFix"></image>饿了么红包
			</view>
